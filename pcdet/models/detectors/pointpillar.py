...
class PointPillar(Detector3DTemplate):
    ...
    def forward(self, batch_dict):
        ...
        feature_show = batch_dict['spatial_features']
        vfeature_show = batch_dict['pspatial_features']
        ...
        if self.training:
            ...
            if num_nonezero != 0:
                loss_ago = self.huber(feature_show * mask, vfeature_show * mask) / num_nonezero
            else:
                loss_ago = 0
            self.iter += 1
