...
class WaymoDataset(DatasetTemplate):
    ...
    def pget_lidar(self, sequence_name, sample_idx):
        lidar_file = self.data_path / sequence_name / ('%04d.npy' % sample_idx)
        point_features = np.load(
            lidar_file.replace('waymo', 'conceptual'))  # (N, 7): [x, y, z, intensity, elongation, NLZ_flag]
    ...
    def __getitem__(self, index):
        ...
        ppoints = self.pget_lidar(sequence_name, sample_idx)  # -#
